...
@Component({
  selector: 'app-future-policy-tagging',
  templateUrl: './future-policy-tagging.component.html',
  styleUrls: ['./future-policy-tagging.component.scss']
})
export class FuturePolicyTaggingComponent implements OnInit {
