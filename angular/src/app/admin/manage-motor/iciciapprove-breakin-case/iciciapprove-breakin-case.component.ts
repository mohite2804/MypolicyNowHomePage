...
@Component({
  selector: 'app-iciciapprove-breakin-case',
  templateUrl: './iciciapprove-breakin-case.component.html',
  styleUrls: ['./iciciapprove-breakin-case.component.css']
})
export class IciciapproveBreakinCaseComponent implements OnInit {
  ...
  submitForm(){
    ...
    this.commonService.posticiciApproveBreakinCase(sendData)
    .subscribe(response =>{
