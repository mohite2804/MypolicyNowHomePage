...
@Component({
  selector: 'app-isuzu-feedfile',
  templateUrl: './isuzu-feedfile.component.html',
  styleUrls: ['./isuzu-feedfile.component.css']
})
export class IsuzuFeedfileComponent implements OnInit {
  ...
  exportAsXLSX(){
    if(this.formRecodEdit.invalid){
     ...
     sendData.append('partner_id','ISUZU');
