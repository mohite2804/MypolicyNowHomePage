...
@Component({
  selector: 'app-commercial-insurance-quote',
  templateUrl: './commercial-insurance-quote.component.html',
  styleUrls: ['./commercial-insurance-quote.component.css']
})
export class CommercialInsuranceQuoteComponent implements OnInit {
  ...
  validation_for_trailor_idv : any = "^[0-9]*$";
  ...
  SelectNoOfTrailer(event){
    ...
    if(event.target.value){
      this.formQuoteDetails.get("trailor_idv").setValidators([Validators.required,Validators.pattern(this.validation_for_trailor_idv)]);
      this.formQuoteDetails.get("trailor_idv").updateValueAndValidity();
      //alert(this.formQuoteDetails.value.no_of_trailer);
      if(this.formQuoteDetails.value.no_of_trailer)
      {
        this.is_trailor=false;
      }
    }else{
      this.formQuoteDetails.get("trailor_idv").setValidators([]);
      this.formQuoteDetails.get("trailor_idv").updateValueAndValidity();
      this.is_trailor=true;
    }
  }
  ...
  checkPreviousPolicyIsThirdParty(){
    ...
    var find : any = policy_sub_type_ids.find(element => element == this.previousPolicy_sub_type_id);
  ...
  checkThirdParty(){
    var policy_sub_type_ids: number[] = [5, 10,11,16,21,23,39];
  ...
  checkComprehnsive(){
    var policy_sub_type_ids: number[] = [3,6,7,8,9,13,14,1,19,25,41,86];
    var find : any =  policy_sub_type_ids.find(element => element == this.policy_sub_type_id);
    if(find > -1){ return true; }else{ return false; }
  }
  ...
  selectPolicySubType(policy_subtype_id){
    ...
    var policy_sub_type_ids: number[] = [3,6,7,8,9,13,14,1,19,4,20,23,25,39,41,86];
    var find : any =  policy_sub_type_ids.find(element => element == this.policy_sub_type_id);
    if(find > -1){
  ...
  ngOnInit(): void {
   ...
   this.selected_product_type_id =  sessionStorage.getItem('selected_product_type_id');
    ...
    if(href == '/share/commercial-truck-gccv-quote'){
      this.selected_product_type_id  = 5;
    }else if(href == '/share/commercial-threewheeler-gccv-quote'){
      this.selected_product_type_id  = 10;
    }else if(href == '/share/commercial-threewheeler-pccv-rickshaw-6-7-quote'){
       this.selected_product_type_id  = 11;
    }else if(href == '/share/commercial-threewheeler-pccv-rickshaw-3-6-quote'){
       this.selected_product_type_id  = 12;
    }else if(href == '/share/commercial-threewheeler-ecart-gccv-quote'){
       this.selected_product_type_id  = 13;
    }else if(href == '/share/commercial-threewheeler-ecart-pccv-quote'){
       this.selected_product_type_id  = 14;
    }else if(href == '/share/commercial-misc-d-quote'){
      this.selected_product_type_id  = 9;
    }else if(href == '/share/commercial-bus-pccv-quote'){
      this.selected_product_type_id  = 7;
    }else if(href == '/share/commercial-taxi-pccv-quote'){
      this.selected_product_type_id  = 4;
    }
  ...
  getIndex(){
    ...
    .subscribe(response => {
      ...
      this.trailer_idv = result.trailer_idv;
      this.is_trailor=result.is_trailor;
    ...
    .subscribe(response => {
      ...
      if(output_data.status){
        ...
        if(output_data.result.product_type_id != this.selected_product_type_id){
          ...
          Swal.fire("Please enter Commercial Registration Number" , "", "error" );
        }else{
  ...
  validationFormQuoteDetails(){
    ...
    this.formQuoteDetails = this.formBuilder.group({
      ...
      carrier_type_id : [''],
      no_of_trailer : [''],
      trailor_idv : ['',[Validators.pattern(this.validation_for_trailor_idv)]],
