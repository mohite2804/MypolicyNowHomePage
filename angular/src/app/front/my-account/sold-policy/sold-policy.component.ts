...
@Component({
  selector: 'app-sold-policy',
  templateUrl: './sold-policy.component.html',
  styleUrls: ['./sold-policy.component.css']
})
export class SoldPolicyComponent implements OnInit {
  ...
  getIndex(){
    ...
    const that = this;
      this.dtOptions = {
          ...
          "processing": true,
          'ajax' : {
              url : this.base_url+'myaccount/get_dashboard_policy',
              type : 'POST',
              headers: {
  ...
  exportDataForm(){
    ...
    this.commonService.exportPolicyData(sendData)
      .subscribe(response =>{
        this.loaderActive = false;
