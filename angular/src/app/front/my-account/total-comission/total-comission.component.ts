...
@Component({
  selector: 'app-total-comission',
  templateUrl: './total-comission.component.html',
  styleUrls: ['./total-comission.component.css']
})
export class TotalComissionComponent implements OnInit {
